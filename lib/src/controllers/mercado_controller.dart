...
class MercadoController extends ControllerMVC {
  ...
  void initState() {
    ...
    url =
        '${GlobalConfiguration().getString('base_url')}payments/mercado/checkout?$_apiToken&$_userId&$_deliveryAddress&$_orderTime';

    flutterWebViewPlugin.onStateChanged.listen((WebViewStateChanged state) {
      if (state != null) {
        if (state.url ==
            "${GlobalConfiguration().getString('base_url')}payments/mercado")
