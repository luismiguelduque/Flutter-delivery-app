...
import 'src/pages/driver_map.dart';
import 'src/pages/driver_profile.dart';
...
import 'src/pages/mercado_payment.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/DriverMap':
        return MaterialPageRoute(builder: (_) => DriverMapWidget(routeArgument: args as RouteArgument));
      case '/Menu':
        return MaterialPageRoute(builder: (_) => MenuWidget(routeArgument: args as RouteArgument));
      case '/DriverProfile':
        return MaterialPageRoute(builder: (_) => DriverProfileWidget(routeArgument: args as RouteArgument));
      case '/Food':
      ...
      case '/Mercado':
        return MaterialPageRoute(builder: (_) => MercadoPaymentWidget(routeArgument: args as RouteArgument));
      case '/OrderSuccess':
